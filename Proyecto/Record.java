...
public class Record extends Actor  
{
    ...
    public void leeRecords()
    {
        ...
        try {
            ...
            while ((linea = bl.readLine()) != null) {
                usuario= new Usuario();
                texto=linea;
                usuario.setnombreJugador(texto);
    ...
    /**@param Usuario us   recibe un objeto del tipo usuario para añadirlo a la lista de record
    ...
    /**
     * Metodo para acomodar los records dependiendo de la puntuacion
     */
